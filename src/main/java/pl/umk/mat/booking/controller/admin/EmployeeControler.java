...
public class EmployeeControler {
    ...
    public String changeEmployeeInfo(@ModelAttribute Employee employee, @RequestParam String field, @RequestParam(required = false) MultipartFile file, RedirectAttributes attributes) {
